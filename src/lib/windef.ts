...
export const PVOID = [Conf._WIN64_HOLDER, 'uint64*', 'uint32*'];    // [_WIN64, _ia32]
export const HANDLE = PVOID;
export const LONG_PTR = [Conf._WIN64_HOLDER, 'int64', 'int32'];
export const ULONG_PTR = [Conf._WIN64_HOLDER, 'uint64', 'uint32'];
...
export const HALF_PTR = [Conf._WIN64_HOLDER, 'int32', 'int16'];
...
export const INT_PTR = [Conf._WIN64_HOLDER, 'int64', 'int32'];
...
export const LPCTSTR = [Conf._UNICODE_HOLDER, LPCWSTR, LPCSTR];
export const LPVOID = 'void*';
export const LPCVOID = LPVOID;
export const LPDWORD = 'uint16*';
export const LPHANDLE = [Conf._WIN64_HOLDER, 'uint64*', 'uint32*'];   // A pointer to a HANDLE.
...
export const LPTSTR = [Conf._UNICODE_HOLDER, LPWSTR, 'uint8*'];
...
export const PCTSTR = [Conf._WIN64_HOLDER, LPCWSTR, LPCSTR];
...
export const PHANDLE = [Conf._WIN64_HOLDER, 'uint64**', 'uint32**'];
export const PHKEY = [Conf._WIN64_HOLDER, 'uint64*', 'uint32*'];
...
export const POINTER_32 = [Conf._WIN64_HOLDER, 'uint64*', 'uint32*'];   // ? A 32-bit pointer. On a 32-bit system, this is a native pointer. On a 64-bit system, this is a truncated 64-bit pointer.
export const POINTER_64 = [Conf._WIN64_HOLDER, 'uint64*', 'uint32*'];  // ? A 64-bit pointer. On a 64-bit system, this is a native pointer. On a 32-bit system, this is a sign-extended 32-bit pointer.
...
export const PTBYTE = [Conf._UNICODE_HOLDER, 'int16*', 'int8*'];
export const PTCHAR = [Conf._UNICODE_HOLDER, 'uint16*', 'uint8*'];
export const PTSTR = [Conf._UNICODE_HOLDER, LPWSTR, LPSTR];
...
export const TBYTE = [Conf._UNICODE_HOLDER, 'int16', 'int8'];
export const TCHAR = [Conf._UNICODE_HOLDER, WCHAR, 'uint8'];
export const UCHAR = 'uchar';
export const UHALF_PTR = [Conf._WIN64_HOLDER, 'uint32', 'uint16'];
