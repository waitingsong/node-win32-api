...
export const PVOID = Conf._WIN64 ? 'uint64*' : 'uint32*';
export const HANDLE = PVOID;
export const LONG_PTR = Conf._WIN64 ? 'int64' : 'int32';
export const ULONG_PTR = Conf._WIN64 ? 'uint64' : 'uint32';
...
export const HALF_PTR = Conf._WIN64 ? 'int32' : 'int16';
...
export const INT_PTR = Conf._WIN64 ? 'int64' : 'int32';
...
export const LPCTSTR = Conf._UNICODE ? LPCWSTR : LPCSTR;
export const LPVOID = 'void*';
export const LPCVOID = LPVOID;
export const LPDWORD = 'uint16*';
export const LPHANDLE = Conf._WIN64 ? 'uint64*' : 'uint32*';   // A pointer to a HANDLE.
...
export const LPTSTR = Conf._UNICODE ? LPWSTR : 'uint8*';
...
export const PCTSTR = Conf._WIN64 ? LPCWSTR : LPCSTR;
...
export const PHANDLE = Conf._WIN64 ? 'uint64**' : 'uint32**';
export const PHKEY = Conf._WIN64 ? 'uint64*' : 'uint32*';
...
export const POINTER_32 = Conf._WIN64 ? 'uint64*' : 'uint32*';   // ? A 32-bit pointer. On a 32-bit system, this is a native pointer. On a 64-bit system, this is a truncated 64-bit pointer.
export const POINTER_64 = Conf._WIN64 ? 'uint64*' : 'uint64*';  // ? A 64-bit pointer. On a 64-bit system, this is a native pointer. On a 32-bit system, this is a sign-extended 32-bit pointer.
...
export const PTBYTE = Conf._UNICODE ? 'int16*' : 'int8*';
export const PTCHAR = Conf._UNICODE ? 'uint16*' : 'uint8*';
export const PTSTR = Conf._UNICODE ? LPWSTR : LPSTR;
...
export const TBYTE = Conf._UNICODE ? 'int16' : 'int8';
export const TCHAR = Conf._UNICODE ? WCHAR : 'uint8';
export const UCHAR = 'uchar';
export const UHALF_PTR = Conf._WIN64 ? 'uint32' : 'uint16';
