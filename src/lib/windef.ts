...
export const PVOID = Conf._WIN64_HOLDER;
export const HANDLE = 'PVOID';
export const LONG_PTR = Conf._WIN64_HOLDER;
export const ULONG_PTR = Conf._WIN64_HOLDER;
...
export const HALF_PTR = Conf._WIN64_HOLDER;
...
export const INT_PTR = Conf._WIN64_HOLDER;
...
export const LPCTSTR = Conf._UNICODE_HOLDER;
export const LPVOID = 'void*';
export const LPCVOID = 'LPVOID';
export const LPDWORD = 'uint16*';
export const LPHANDLE = Conf._WIN64_HOLDER;   // A pointer to a HANDLE.
...
export const PCTSTR = Conf._WIN64_HOLDER;
...
export const PHANDLE = Conf._WIN64_HOLDER;
export const PHKEY = Conf._WIN64_HOLDER;
...
export const POINTER_32 = Conf._WIN64_HOLDER;   // ? A 32-bit pointer. On a 32-bit system, this is a native pointer. On a 64-bit system, this is a truncated 64-bit pointer.
export const POINTER_64 = Conf._WIN64_HOLDER;  // ? A 64-bit pointer. On a 64-bit system, this is a native pointer. On a 32-bit system, this is a sign-extended 32-bit pointer.
...
export const PTBYTE = Conf._UNICODE_HOLDER;
export const PTCHAR = Conf._UNICODE_HOLDER;
export const PTSTR = Conf._UNICODE_HOLDER;
...
export const TBYTE = Conf._UNICODE_HOLDER;
export const TCHAR = Conf._UNICODE_HOLDER;
export const UCHAR = 'uchar';
export const UHALF_PTR = Conf._WIN64_HOLDER;
...
export const macroMap: GT.MacroMap = <GT.MacroMap> new Map([
    ...
    ['LPCTSTR', [Conf._UNICODE_HOLDER, LPCWSTR, LPCSTR]],
    ['LPHANDLE', [Conf._WIN64_HOLDER, 'uint64*', 'uint32*']],
    ['LPTSTR', [Conf._UNICODE_HOLDER, LPWSTR, 'uint8*']],
    ['PCTSTR', [Conf._WIN64_HOLDER, LPCWSTR, LPCSTR]],
    ...
    ['PTSTR', [Conf._UNICODE_HOLDER, LPWSTR, LPSTR]],
    ['TBYTE', [Conf._UNICODE_HOLDER, 'int16', 'int8']],
    ['TCHAR', [Conf._UNICODE_HOLDER, WCHAR, 'uint8']],
